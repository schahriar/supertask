...
var Task = function ST__TASK_MODEL(ST_DO, name, func, type, model) {
    this._do = ST_DO;
...
module.exports = {
    create: function ST__CREATE_TASK(ST_DO, name, func, type) {
        return new Task(ST_DO, name, func, type, null);
    },
    wrap: function ST__WRAP_TASK(ST_DO, model) {
        return new Task(ST_DO, null, null, null, model);
    }
};