...
*/
var PROP = [
    { n: "averageExecutionTime", i: 0.80, rule: { asc: ST_O_AET_ASC, dsc: ST_O_AET_DSC }, MIN_O_LEVEL: ST_O2 },
    { n: "executionRounds", i: 0.20, rule: { asc: ST_O_ER_ASC, dsc: ST_O_ER_DSC }, MIN_O_LEVEL: ST_O2 }
];
